...
from sabotage.configs.loader import register_schema
...
def _load_stage_registry(package: str = "sabotage") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in sabotage.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from sabotage.configs.loader import config_to_dict, save_resolved_config
    from sabotage.models.device import get_device
    from sabotage.utils.logging import configure_logging
    from sabotage.utils.reproducibility import set_seed
    from sabotage.utils.run_manifest import create_run_dir, save_run_metadata
